...
export default class Estimator extends React.Component {
  ...
  render() {
    return <div className="container">
      ...
      <hr id="separator"/>
      <section className="qSection">
        <p> Page last updated 11:30am ET, 9/12/2020. </p>
