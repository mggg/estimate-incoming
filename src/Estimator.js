...
export default class Estimator extends React.Component {
  ...
  render() {
    return <div className="container">
      ...
      <hr id="separator"/>
      <section className="qSection">
        <p>Page last updated 08:49am ET, 01/20/2021</p>
        <p style={{textAlign: 'left', padding: '10px'}}>
         ...
         Finally, we use <a href="https://www.medrxiv.org/content/10.1101/2020.07.13.20152793v2" target="_blank">supplemental data</a> on the PCR test positivity (see Figure 4 of the linked PDF) with a 3-day lag to estimate that a positive test will occur on day 3-21 after initial infection, with a linearly diminishing probability each day. So our positivity rate is a (discounted) sum of the new infections from 3-21 days prior.<br/><br/>
